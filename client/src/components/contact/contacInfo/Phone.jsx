  ...
  return (
    <div className='w-full'>
      ...
      <div className='flex justify-center'>
        <a name="phone" className='flex justify-center items-center bg-[#368a8c] w-14 h-14' href="https://wa.me/2473509269?text=Hola%20me%20interesaria%20charlar%20sobre%20una%20propiedad%20en%20especifico." target="_blank">
      ...
      <div className='w-full flex flex-col items-center justify-center'>
        ...
        <div className='flex flex-col justify-center items-center gap-4 mt-4'>
          <a name="phone" href="tel:2473509269" target="_blank" className='hover:cursor-pointer'>
