  ...
  return (
    <div className='w-full'>
      ...
      <div className='w-full flex flex-col items-center justify-center gap-4 px-4'>
        ...
        <a aria-label="location" href="https://www.google.com/maps/place/-33.895401,+-61.099643/@-33.8954262,-61.0994997,21z/data=!4m4!3m3!8m2!3d-33.8954009!4d-61.0996432?hl=es" target="_blank" className="text-lg text-white p-3 border-[#368a8c] md:border-white border-2 hover:opacity-50">Abrir en el mapa</a>
      </div>
