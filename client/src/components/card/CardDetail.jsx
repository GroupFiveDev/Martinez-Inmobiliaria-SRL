            ...
            <div className="xl:w-[70%] flex flex-col items-center">
              ...
              <div className="w-full px-4 flex justify-start flex-col items-start text-white mt-4 gap-4">
                <div className="flex items-center w-full gap-2">
                  <p
                    className={`${edit.description ? "hidden" : "flex"
                      } text-xl flex`}
                  >
                  ...
                  {property?.type === "field" ? (
                    <>
                      <div className="text-white flex flex-col gap-4">
                        <div
                          className={`${property?.hectares ? "" : "hidden"
                        ...
                        >
                          ...
                          <input
                            ...
                            className={`${edit.hectares ? "flex" : "hidden"
                        ...
                        <div
                          className={`${property?.terrain ? "" : "hidden"
                            } gap-2 flex items-center font-bold text-white`}
                        >
                          APTITUD:
                          <div
                          ...
                          <select
                            ...
                            className={`${edit.terrain ? "flex" : "hidden"
                              } w-[80%] text-black`}
                          >
                    ...
                    <>
                      <div
                        className={`flex flex-wrap justify-center items-center ${edit.rooms ? "gap-10" : "gap-5"
                          }`}
                      >
                        <div
                          className={`${property?.rooms ? "" : "hidden"
                        ...
                        >
                          ...
                          <input
                            ...
                            className={`${edit.rooms ? "flex" : "hidden"
                              } w-16 h-10 text-black`}
                          />
                        </div>
                        <div
                          className={`${property?.bathrooms ? "" : "hidden"
                        ...
                        <div
                          className={`${property?.garage ? "flex" : "hidden"
                        ...
                        <div
                          className={`${property?.square ? "" : "hidden"
                            }text-white flex items-center font-bold`}
                        >
                ...
                <div
                  className={`${property?.location ? "flex" : "hidden"
                    }text-white flex flex-wrap items-center gap-2`}
                >
                  <div
                    className={`${property?.location ? "" : "hidden"
                ...
                <div
                  className={`${property?.price ? "" : "flex"
                    } text-white font-bold`}
                >
                  <div
                    className={`${property?.price ? "" : "hidden"
                  ...
                  >
                    ...
                    <input
                      ...
                      className={`${edit.price ? "flex" : "hidden"
                        } w-[80%] h-[26px] text-black`}
                    />
                    <Edit
                      value={edit.price}
