...
export default function Card({
  ...
  return (
    <>
      <div
        className={`relative max-w-sm bg-white border border-gray-200 rounded-lg shadow m-3 ${
          loading ? "opacity-50" : ""
        }`}
      >
        ...
        <button
          ...
          type="button"
          className="absolute top-0 left-0 text-white bg-[#368a8c] hover:bg-[#2c7172] font-medium rounded-lg text-sm px-2.5 py-2 text-center inline-flex items-center ml-2 mb-2 mt-2"
        >
